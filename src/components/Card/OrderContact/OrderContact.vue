      ...
      <div v-else-if="activeTab === 'pickup'" class="wrapper">
        ...
        <div class="time-order">
          ...
          <div class="block-btn-width">
            <button class="btn-order-time" @click="minActive('min-25')" :class="{ 'active': activeMin === 'min-25' }">25 мин</button>
            <button class="btn-order-time" @click="minActive('min-30')" :class="{ 'active': activeMin === 'min-30' }">30 мин</button>
            <button class="btn-order-time" @click="minActive('min-40')" :class="{ 'active': activeMin === 'min-40' }">40 мин</button>
            <button class="btn-order-time" @click="minActive('min-50')" :class="{ 'active': activeMin === 'min-50' }">50 мин</button>
            <button class="btn-order-time" @click="minActive('min-60')" :class="{ 'active': activeMin === 'min-60' }">60 мин</button>
          </div>
        </div>
        <div class="change_wrapper_btn">
          <h1 class="title_change">Способ оплаты</h1>
